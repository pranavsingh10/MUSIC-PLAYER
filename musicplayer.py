...
if __name__ == '__main__':
    ...
    Label(root, text="Created by Pranav and Anubhav", font="lucida 10", bg="grey", fg="white").pack(fill=X, pady=25)
    Label(root, text="INT213 Project", font="lucida 10", bg="black", fg="white").pack()
